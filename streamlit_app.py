...
data = {
    ...
    "FC_media": [112, 112, 118, 112, 112, 90, 103, None, 110, 91, 125],
    "FC_max": [155, 126, 146, 159, 159, 124, 115, None, 138, 99, 162],
    "Vel_media": [6.2, 5.2, 6.1, 4.7, 4.7, 5.4, 5.8, 5.3, 5.6, 5.2, 7.3],
    "Vel_max": [19.0, 7.5, 9.9, 12.5, 12.5, 12.7, 8.9, 9.2, 9.3, 11.8, 11.1],
    "Calorie": [1686, 750, 814, 2320, 2320, 1552, 1016, None, 722, 1377, 823],
